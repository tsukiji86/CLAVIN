 ...
 * ====================================================================
 * 
 * DutchLanguageDemo.java
 * 
 *###################################################################*/

/**
 * Demonstrates the use of CLAVIN against a Dutch dataset.
 */
public class DutchLanguageDemo {

	/**
	 * Extract and resolve a Dutch language document.
	 * @param args ignored.
	 * @throws Exception
	 */
	public static void main(String[] args) throws Exception {
		...
		// Override the default extractor with the new Dutch Language extractor.
		...
		// Parse the article.
		ResolutionContext results = geoParser.parse(dutchText);
