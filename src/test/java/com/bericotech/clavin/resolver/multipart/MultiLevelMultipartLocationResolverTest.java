...
public class MultiLevelMultipartLocationResolverTest {
    ...
    public static Iterable<Object[]> parameters() {
        return Arrays.asList(new Object[][] {
            ...
            { Arrays.asList("London", "England", "United Kingdom"), LONDON_UK_41 },
            ...
            { Arrays.asList("London", "ENG", "UK"), LONDON_UK_41 },
            { Arrays.asList("London", "ENG", "GB"), LONDON_UK_41 },
            ...
            { Arrays.asList("London", "", "UK"), LONDON_UK_41 },
            { Arrays.asList("London", "", ""), LONDON_UK_41 },
